...
import 'package:closet_my_wardrobe_40_a/main.dart';
...
class AddImageScreen extends StatefulWidget {
  AddImageScreen({super.key, required this.click, this.model});
...
class _AddImageScreenState extends State<AddImageScreen> {
  ...
  void initState() {
    if (widget.model != null) {
      _image = File(widget.model!.image[0]);
    }
    super.initState();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                constraints: BoxConstraints(minHeight: 108.h, maxHeight: 300.h),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(16.r),
              ...
              CMWMoti(
                onPressed: () {
                  if (_image != null &&
                      textBrand.isNotEmpty &&
                      textWhereToWear.isNotEmpty &&
                      nameController.text.isNotEmpty &&
                      howRoWearController.text.isNotEmpty) {
                    data.put(
                        '${getIdAlert()}',
                        Detailodejdamodel(
                            id: "${getIdAlert()}",
                            image: [stringImageForSaveAndroid],
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _image != null &&
                        ...
                        textWhereToWear.isNotEmpty &&
                        nameController.text.isNotEmpty &&
                        howRoWearController.text.isNotEmpty ? CMWColor.blue :Colors.grey,
                    borderRadius: BorderRadius.circular(16.r),
                  ),
                  child: Row(
